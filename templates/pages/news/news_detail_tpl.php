                ...
                <div class="row mt20">
                    <div class="col-12 item">
                        ...
                        <div class="i-shareLinks i-other-news mb20">
                            ...
                            <div class="VLB center pb5">Bài Viết Liên Quan</div>
                            <img src="./assets/images/pdp/iconCAFE.png" class="centerimg mb10">
                            <div class="owl-carousel owl-theme carousel-product-news col-m-10" id="slider__other">
                                <?php foreach($tintuc as $other){?>
                                <div class="article">
                                    <div class="thumb hover-left <?php if($com=='chinh-sach') echo ' d-none';?>">

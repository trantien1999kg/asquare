...
font-family: 'SVNNOVAC';

src: url('assets/images/fonts/SVNNOVAC.ttf') format('truetype');
...
src: url('assets/images/fonts/VLB.OTF') format('truetype');
...
src: url('assets/images/fonts/VLL.OTF') format('truetype');

<section class="slidersanpham pt40 pb70"
    ...
    <?php foreach ($featuredcategory as $ke => $va) { 
        $products = $db->rawQuery("select ten_$lang as ten, tenkhongdau_$lang as tenkhongdau , photo , type from #_baiviet where hienthi=1 and id_list=? order by stt asc,id desc",array($va['id']));
       ?>
    <div class="slidedanhmuc">
        <div class="titleCF">
            ...
            <div class="tendmsp mb60 wow slideInLeft" data-wow-delay="0.2s">
            <?= $va['ten']?>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="owl-carousel owl-theme item owl-splist">
                    ...
                    <div class="machine-coffee  wow fadeInUp" data-wow-delay="<?= $key*0.2?>s">
                        <a href="<?= $value['type']?>/<?= $value['tenkhongdau']?>">
                            ...
                            <div class="mayphacafe">
                                <h4 class="tenMachine line-1"><?= $value['ten']?>&nbsp;<span class="gachkhuc"></span>
                                </h4>

...
$GLOBAL['baiviet'][$nametype]['img-ratio'] = 3;
...
(
	...
	$GLOBAL['baiviet'][$nametype]['title_main'] = 'Feedback';
...
#=========================================DANH SÁCH ẢNH PHA CHẾ=============================================================
	
$nametype='hinh-anh';

$GLOBAL['baiviet'][$nametype]['title_main'] = 'DANH SÁCH ẢNH PHA CHẾ';
...
$GLOBAL['baiviet'][$nametype]['file_type']='doc|docx|pdf|rar|zip|ppt|pptx|DOC|DOCX|PDF|RAR|ZIP|PPT|PPTX|xls|jpg|png|gif|JPG|PNG|GIF|xls|XLS';
	...
	$GLOBAL['info'][$nametype]['full'] = true;
	...
	$GLOBAL['info'][$nametype]['cano'] = true;
...
(
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'logo mobile footer';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý logo mobile footer';
	...
	$GLOBAL['bannerqc'][$nametype]['img_type']='.swf|.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.webp';
		...
		$nametype='bg_bottomsanpham';

		$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background BOTTOM SẢN PHẨM';
	...
	$nametype='bg_sanphamlist';

	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background SLIDER SẢN PHẨM';
	...
	$nametype='bg_trangtrong';

	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background TRANG TRONG';
	...
	$GLOBAL['bannerqc'][$nametype]['img_type']='.swf|.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.webp';
			...
			$nametype='bg_breadcumb';

			$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background BREADCUM';
			...
			$nametype='bg_menumobile';

			$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background MENU MOBILE';
			...
			#====================bg THÔNG TIN LIÊN HỆ============================

			$nametype='bg_lienhe';

			$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background THÔNG TIN LIÊN HỆ';
...
$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background TIN COFFEE ';

$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý background TIN COFFEE ';
...
$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background FEEDBACK ';

$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý background FEEDBACK ';

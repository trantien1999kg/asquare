            ...
            <div class="<?=($table['full']==true) ? 'oneOne':'colLeft' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <label>Tạo cấu trúc(schema) bài viết</label>

                        <div class="formRight">

                            <textarea name="data[schema_text]" rows="10" title="Nhập schema" id="schema_text"
                                class="tipS"><?=@$item['schema_text']?></textarea>
                    ...
                    <?php if($table['thongso']==true){ ?>

                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">

                        <label>THÔNG SỐ [<?=$v?>]</label>

                        <div class="ck_editor">

                            <textarea data-validation="required" data-validation-error-msg="Không được để trống"
                                title="Nhập nội dung [<?=$v?>]. " data-height="400" id="thongso_<?=$k?>"
                                <?= ($table['thongso-ckeditor']==true) ? 'class="ck_editors"':'rows="8"' ?>
                                name="data[thongso_<?=$k?>]"><?=@$item['thongso_'.$k]?></textarea>
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <label>TÁC GIẢ [<?=$v?>]</label>

                        <div class="ck_editor">

                        <input type="text" data-validation="required"
                                data-validation-error-msg="tacgia không được để trống" name="data[tacgia]" title="Nhập tacgia"
                                id="tacgia" class="tipS" value="<?=@$item['tacgia']?>" />
...
<script>
$(document).ready(function() {
    /* chạy document html css thẻ div rồi mới mở tới function ra */
